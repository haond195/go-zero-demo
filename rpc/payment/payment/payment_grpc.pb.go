...
func (c *paymentClient) ProcessPayment(ctx context.Context, in *ProcessPaymentReq, opts ...grpc.CallOption) (*ProcessPaymentResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProcessPaymentResp)
...
type PaymentServer interface {
	ProcessPayment(context.Context, *ProcessPaymentReq) (*ProcessPaymentResp, error)
...
func (UnimplementedPaymentServer) ProcessPayment(context.Context, *ProcessPaymentReq) (*ProcessPaymentResp, error) {
...
func _Payment_ProcessPayment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServer).ProcessPayment(ctx, req.(*ProcessPaymentReq))
	}
